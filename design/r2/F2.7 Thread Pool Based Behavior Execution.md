...
| Feature Id | Name | Dependent |
| --- | --- | --- |
| 7.1 | [[#Lock-free queue service]] | 7.2 |
| 7.2 | [[#Service framework supports inject prototype service attribute]] | None |
| 7.3 | [[#Basic Thread Management]] | None |
| 7.4 | [[#Directly Behavior Execution]] | 7.1, 7.3 |
| 7.5 | [[#Send Message]] | 7.1, 7.3 |
...
Below modules should be changed:
* uapi.service
* uapi.service.apt
* uapi.config
